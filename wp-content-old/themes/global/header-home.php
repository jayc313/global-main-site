        ...
        <div class="row">
            ...
            <div class="offset-1 col-6">
                ...
                <span>
                    ...
                    <button class="btn no-style rounded c-primary--black btn-sm">Overview</button>
                    <button class="btn no-style rounded c-primary--black btn-sm">Film</button>
                    <button class="btn no-style rounded c-primary--black btn-sm">Brand</button>
                    <button class="btn no-style rounded c-primary--black btn-sm">Digital</button>
                </span>

                </p>
            </div>
            <div class="col-3 tar fdir-rr">
                <a href="" class="btn no-style rounded btn-sm bg-primary--black c-primary--white">01202 727070</a>
            </div>
        </div>
    </div>
</div>