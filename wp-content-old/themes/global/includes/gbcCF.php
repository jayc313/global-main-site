...
function create_component_block($component) {
    ...
    // wp_enqueue_style($this->currentComponentSlug);

    Block::make(__($component[0]))
        ->add_fields($component[1])
       // ->set_editor_style( $this->currentComponentSlug )
  ...
  var active = false;
    ...
    document.querySelector('fieldset.container-carbon_fields_container_builder').addEventListener('click', function(){
          if (active == false) {
            ...
            // for (var i = 0; i < document.querySelectorAll('ul.cf-complex__inserter-menu li.asterisk').length; i++) {
            //     document.querySelectorAll('ul.cf-complex__inserter-menu li.asterisk')[i].remove();
            // }
...
// var cfAccord = document.querySelectorAll('.cf-separator.accord-open');
// var currentField;

// document.addEventListener( 'click', openAccords );

// function openAccords(event) {
//     var element = event.target;

    

//     if (element.classList.contains('accord-open')) {
//         currentField = element;
//     } else if (element.closest('.accord-open')) {
//         currentField = element.closest('.accord-open');
//     } else {
//         return;
//     }

//     currentField.classList.toggle('open');


//     currentField = currentField.nextSibling;


//     while (currentField.nextSibling) {
//         if (currentField.classList.contains('accord-close')) {
//             return;
//         }

//         currentField.classList.toggle('closed')
//         currentField = currentField.nextSibling;
//     }
// }
...
//     if (element.closest('#carbon_fields_container_builder')) {

//         if (!act) { act = true; } else { return; }

//         for (let index = 0; index < document.querySelectorAll('.cf-separator.accord-open').length; index++) {
        
//             currentField = document.querySelectorAll('.cf-separator.accord-open')[index].nextSibling;
        
//             while (currentField.nextSibling) {
//                 if (currentField.classList.contains('accord-close')) {
//                     break;
//                 }
//                 currentField.classList.add('closed')
//                 currentField.classList.add('accord-field')
//                 currentField = currentField.nextSibling;
//             }
