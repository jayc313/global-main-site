...
function gbc_enqueue_block_editor_assets() {
  add_editor_style(get_stylesheet_directory_uri() . '/layout.css');
  add_editor_style(get_stylesheet_directory_uri() . '/main.css');

}
add_action('after_setup_theme', 'gbc_enqueue_block_editor_assets');
